...
description: Systematic network error diagnosis and resolution
globs:
alwaysApply: true
---
...
When network errors occur, apply this systematic diagnostic workflow.

## Triggers

- Errors containing: ECONNREFUSED, ECONNRESET, ETIMEDOUT, ENOTFOUND, timeout, connection refused, connection reset, SSL, certificate, proxy, DNS, 502, 503, 504
- Commands failing: npm install, pip install, git push/pull, docker pull, curl, wget
...
Match error message to category above.
